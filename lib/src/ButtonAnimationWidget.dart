...
class ButtonAnimationWidget extends StatefulWidget {
  ...
  const ButtonAnimationWidget({Key key, this.idProducto, this.cantidadAnimation, this.precio, this.idUsuario,this.changeSize}) : super(key: key);
...
class ButtonAnimationWidgetState extends State<ButtonAnimationWidget> with TickerProviderStateMixin {
    ...
    return AnimatedPositioned(
      ...
      child: Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(
            height: changeSize ? 50.0 : 30.0,
              //            height: 30.0,
              // color: Colors.yellow,
                  child: Card(child: Center(child: Text('Añadir',style: TextStyle(color:Color.fromRGBO(5, 175, 242, 1),fontSize:changeSize ? 25 : 12),))),
            ),
        ),
      ),
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child:
                        ...
                        IconButton(
                          icon: Icon(Icons.remove ,size: changeSize ? 40:30.0,color: colorChange2,),
                        onPressed:()async {
