...
import 'package:tienda_mimi/src/GoogleMaps/Trip.dart';
import 'package:tienda_mimi/src/GoogleMaps/Place.dart';
import 'package:tienda_mimi/src/GoogleMaps/divider_with_text_widget.dart';
//import 'date_view.dart';
//import 'package:tienda_mimi/src/GoogleMaps/credentials.dart';
import 'package:dio/dio.dart';
import 'package:auto_size_text/auto_size_text.dart';
import 'dart:async';
const PLACES_API_KEY='AIzaSyAmHf-zqOVz20UV8icbaK8CPF_pzgiLkpA';

class NewTripLocationView extends StatefulWidget {
  final Trip trip;

  NewTripLocationView({Key key, this.trip}) : super(key: key);
